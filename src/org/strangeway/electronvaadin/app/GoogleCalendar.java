...
public class GoogleCalendar {
    ...
    private static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("user.home"), "/electron-java-app");
    ...
    public static com.google.api.client.auth.oauth2.Credential authorize() throws IOException {
        ...
        System.out.println(GoogleCalendar.class.toString());
        InputStream in =
